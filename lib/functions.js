...
exports.getCurrentError = exports.createValidators = void 0;
exports.createValidators = function (conf, methods) {
    if (!conf.validators) {
        return {};
    }
    ...
    var validate = Object.keys(conf.validators.validate)
...
exports.getCurrentError = function (conf, errors) {
